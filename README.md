...
The canonical OpenAPI 3.1 contract, compatibility rules, fixture coverage and drift-check workflow are documented in `docs/api-contract.md`; the generated contract is published under `contract/v1/`.
